...
WHERE account_firstname = 'Tony'
  AND account_lastname = 'Stark';
--4
UPDATE public.inventory --select * from public.inventory
...
--WEEK 6 ADDITIONS
--Table structure for table 'monsterupgradetype'
CREATE TABLE IF NOT EXISTS public.upgradetype (
  type_id INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY,
  up_type CHARACTER VARYING NOT NULL,
  CONSTRAINT monsterupgradetype_pkey PRIMARY KEY (type_id)
);
INSERT INTO public.upgradetype (up_type)
VALUES ('Engine-Parts'),
  ('Decals'),
  ('Stickers'),
  ('Rims') --Table structure for table 'upgradeinventory'
  CREATE TABLE IF NOT EXISTS public.upgradeinventory (
    up_inv_id INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY,
    up_inv_item CHARACTER VARYING NOT NULL,
    up_inv_description TEXT NOT NULL,
    up_inv_image CHARACTER VARYING NOT NULL,
    up_inv_thumbnail CHARACTER VARYING NOT NULL,
    up_inv_price NUMERIC(9, 0) NOT NULL,
    up_type_id INTEGER NOT NULL,
    CONSTRAINT upgradeinventory_pkey PRIMARY KEY (up_inv_id)
  );
-- Data for table `upgradeinventory`
INSERT INTO public.upgradeinventory (
    up_inv_item,
    up_inv_description,
    up_inv_image,
    up_inv_thumbnail,
...
VALUES (
    '4x4 Decal',
    'Decal for any 4x4 truck or SUV',
    '/images/decals/4x4.jpg',
    '/images/decals/4x4.jpg',
    8,
    2
  ),
  (
    'Dent Cover',
    'Dents from offroading, cover then up with a dent cover',
    '/images/decals/coverdent.jpg',
    '/images/decals/coverdent2.jpg',
    10,
    2
  ),
  (
  ...
  (
    'TRD Offroading',
    'Toyota Tundra TRD Offroad decal',
    '/images/decals/trd-decal.jpg',
    '/images/decals/trd-decal.jpg',
    9,
    2
  ),
  (
    'Other Car is a Different Car',
    'Funny bumper stickers',
    '/images/bumperstickers/different-car-bumper-sticker.jpg',
    '/images/bumperstickers/different-car-bumper-sticker2.jpg',
    6,
    3
  ),
  (
    'Student Driver',
    'Student driver bumper sticker',
    '/images/bumperstickers/studentdriver.jpg',
    '/images/bumperstickers/studentdriver.jpg',
    6,
    3
  )